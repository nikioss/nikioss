...
## 🚀 Проекты
- **[Проект 1](https://github.com/nikioss/Movie_review)** — Cистема для автоматической классификации отзывов о фильмах(положительный или негатиыный) с присвоением рейтинга от 1 до 10
